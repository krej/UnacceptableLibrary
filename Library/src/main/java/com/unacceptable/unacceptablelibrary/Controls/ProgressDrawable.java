...
public class ProgressDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawRect(0,0, b.right /(float) 3, b.bottom, mPaint);

        mPaint.setColor(mBackground);
        canvas.drawRect(b.right / (float) 3, 0, b.right * ((float)2/3), b.bottom, mPaint);

        mPaint.setColor(mForeground);
        canvas.drawRect(b.right * ((float)2/3), 0, b.right, b.bottom, mPaint);
/*
